...
using TokenService.API.Models.AccountViewModels;
using TokenService.API.Services;
using LoginViewModel = TokenService.API.Models.AccountViewModels.LoginViewModel;
...
namespace TokenService.API.Controllers
{
    ...
    public class AccountController : Controller
    {
            ...
            IHttpContextAccessor httpContextAccessor)
        {
            ...
            _accountService = new AccountService(interaction, httpContextAccessor);
        }
